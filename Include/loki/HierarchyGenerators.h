...
////////////////////////////////////////////////////////////////////////////////
	...
	struct TupleUnit
	{
		typedef typename T AType;
		AType value_;
		operator AType&() { return value_; }
		operator const AType&() const { return value_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct Tuple : public Loki::GenScatterHierarchy<TList, TupleUnit>
	{
	};
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct FieldHelper<H, 0>
	{
		...
		typedef IntSelect<isConst, typename ConstLeftBase, typename H::LeftBase>::Result LeftBase;

		typedef IntSelect<isTuple, ElementType,
			UnitType>::Result UnqualifiedResultType;

		typedef IntSelect<isConst, const UnqualifiedResultType,
    ...
    struct FieldHelper
    {
		...
		typedef TL::TypeAtNonStrict<typename H::TList, i>::Result ElementType;
        typedef H::template Rebind<ElementType>::Result UnitType;
		...
		typedef IntSelect<isConst, typename ConstRightBase,
